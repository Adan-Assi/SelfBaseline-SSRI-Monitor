...
Recent Android versions are recommended for compatibility with Expo.
...
> Note: The first Android build may take several minutes, and can take up to 20 minutes.
